...
class Board:
    ...
    color={
     ...
     # constructor: It opens ths agem window and initializes the flag variables
    def __init__(self):
        self.n=4
        self.window=Tk()
        ...
        for i in range(4):
            for j in range(4 - 1):
                if self.gridCell[i][j] == self.gridCell[i][j + 1] and self.gridCell[i][j] != 0:
                    ...
                    self.merge = True
    #First goes through the whole gridCell list and collects the indices of the empty cells
...
class Game:
    ...
    def play(self):
     ...
     #It calls random_cell twice to assign ‘2’ to gridCell value of two random cells and then it paints the grid
    def start(self):
